...
const styles = StyleSheet.create({
  ...
  banner: { backgroundColor: 'rgba(212,255,0,0.06)', borderColor: 'rgba(212,255,0,0.25)', borderWidth: 1, padding: SPACING.lg, borderRadius: RADII.md, marginBottom: SPACING.lg },
  ...
  segItem: { flex: 1, paddingVertical: 8, alignItems: 'center', borderRadius: RADII.pill },
  segItemActive: { backgroundColor: COLORS.brand },
  segText: { color: COLORS.onSurfaceSecondary, fontSize: TYPE.sm, fontWeight: '700' },
